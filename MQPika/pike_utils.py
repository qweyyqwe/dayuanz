...
class SingletonClass(object):
    ...
    def __init__(self, username='admin', password='123456', ip='192.168.10.8', port=5672, data={}):
...
if __name__ == '__main__':
    ...
    print(id(obj1))
    # 发布消息
    obj1.this_publisher('3413299451@qq.com')

    obj2 = SingletonClass()
    print(id(obj2))
    # 发布消息
    obj2.this_publisher('3413299451@qq.com')
