# Generated by Django 2.2.7 on 2022-06-20 11:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(max_length=255, unique=True, verbose_name='邀请码')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.CharField(max_length=255, null=True, unique=True, verbose_name='头像')),
                ('uid', models.CharField(max_length=255, null=True, unique=True, verbose_name='第三方登录的id')),
